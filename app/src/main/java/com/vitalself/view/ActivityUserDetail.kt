...
import com.vitalself.databinding.ActivityUserDetailBinding
import com.vitalself.model.Model
import com.vitalself.adapter.SpinnerAdapter
...
class ActivityUserDetail : BaseActivity() {
...
//    private lateinit var dateRestrictionManager: ScanRestrictionManager
    ...
    companion object {
        ...
        fun startActivity(activity: Activity,title:String) {
            Intent(activity, ActivityUserDetail::class.java).apply {

...
import com.vitalself.bottom_sheets.VitalsBottomSheetDialog
import com.vitalself.databinding.ActivityVitalResultBinding
import com.vitalself.model.VitalListItem
    ...
    private fun initUi() {
        try {
           ...
           vitals?.let {
            ...
            adapter = AdapterVitalList(list, this@VitalResultActivity)
...
object VitalCategories {
    // Define section constants based on your existing VITAL_CATEGORY enum

package com.vital_self.legacy.adapters
            ...
            binding.vitalStatus.apply {
                text = when {
                    ...
                    healthStatus.vitalName.contains("Heart age") -> "Your ${healthStatus.vitalName} is ${healthStatus.vitalValue} Years"
                        ...
                        AppConstants.HIGH -> "Your ${healthStatus.vitalName} is High"
                        AppConstants.NORMAL -> "Your ${healthStatus.vitalName} is Normal"
                        AppConstants.LOW -> "Your ${healthStatus.vitalName} is Low"
                        AppConstants.MEDIUM -> "Your ${healthStatus.vitalName} is Medium"

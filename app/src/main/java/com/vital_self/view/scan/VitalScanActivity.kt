package com.vital_self.view.scan
...
import com.vital_self.dialog.DialogHowToScan
...
import com.vital_self.utils.BinahErrorMessage
...
class VitalScanActivity : BaseActivity(),
    ...
    lateinit var historyViewmodel: LocalHistoryBDViewmodel
            ...
            AlertDialogManager.showConfirmationDialog(this,
                ...
                dialogClickListener = object : DialogClickListener {
                    override fun onButton1Clicked() {
                        ActivityProfile.startActivity(this@VitalScanActivity,Constant.PROFILE)
                    ...
                    Status.SUCCESS -> {
                        ...
                        try {
                            ...
                            if (it.data?.user?.availableScan!! > 0 && it.data.user.status == true){
                                ...
                                Log.d(TAG, "observable: user data ${Pref.user?.licenseKey}")
                            }else{
    ...
    override fun onFinalResults(finalResults: VitalSignsResults?) {
        ...
        runOnUiThread {
            ...
            if(isTerminated){
                ...
                VitalResultActivity2.Companion.startActivity(this,list,subject,wellnessIndex,wellnessLevel,date,time,true)
                finish()
            }
        }
